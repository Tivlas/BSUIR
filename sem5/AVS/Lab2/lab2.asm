...
; регистры общего назначения
                   dd    0,0,0,0,0,stack_l2,0,0,0B8040h ; (ESP и EDI)
; сегментные регистры
...
; в защищенный режим
        ...
        mov bl, 97
task_0:
        mov        byte ptr ds:[edi],bl ; вывести символ на экран
; дальний переход на TSS задачи 1
        db         0EAh
        dd         0
        dw         SEL_TSS1
        add        edi,2               ; DS:EDI - адрес следующего символа
        inc        bl                   ; код следующего символа,
        cmp        bl,123                ; если это limit,
