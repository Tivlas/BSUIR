...
task_0:
        mov al, 97
        mov        byte ptr ds:[edi],ah ; вывести символ AL на экран
; дальний переход на TSS задачи 1
        db         0EAh
        dd         0
        dw         SEL_TSS1
        add        edi,1                ; DS:EDI - адрес следующего символа
        inc        al                   ; AL - код следующего символа,
        cmp        al,98                ; если это number,
...
; задача 1
task_1:
        mov        byte ptr ds:[edi],ah ; вывести символ на экран
        inc        al                   ; увеличить код символа
        add        edi,1               ; увеличить адрес символа
