...
GENERATE_DRAW_FUNCTION(R, 200, 100, 290, 500, 255, 0, 0);
GENERATE_DRAW_FUNCTION(G, 100, 100, 590, 300, 0, 255, 5);
GENERATE_DRAW_FUNCTION(B, 150, 100, 690, 0, 0, 0, 255);
					...
					case ID_BUTTON_START:
						{
							if(pause_press) {
								if(threads_suspend) {
									...
									SetThreadPriority(threads[2], THREAD_PRIORITY_LOWEST);
